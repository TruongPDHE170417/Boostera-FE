                  ...
                  <ul className="list-inside list-decimal">
                    <li>
                      <span className="m-0 text-white">
                        Never flame during your games on the customer&apos;s account. Causing a ranked restriction or
                        ban on the customer&apos;s account will lead to a cash penalty or ban on the service.
                      </span>
                    </li>
                    <li>
